...
type Mutations = {
  ...
  [MutationTypes.SET_DAILY_SALES_OVERVIEW](state: RootState, data: DailySalesOverviewData): void;
  ...
  [MutationTypes.SET_DAILY_SALES_SKU_LIST](state: RootState, data: DailySalesSkuListData): void;
  ...
  [MutationTypes.SET_SKU_REFUND_RATE_DATA](state: RootState, data: SkuRefundRateData): void;
};
